  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative mt-10 z-10 max-w-6xl px-6 w-full">
          <motion.div
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-full border border-pink-400 text-white hover:bg-pink-400/10 transition"
                >
                  View Services
                </button>
              </motion.div>
