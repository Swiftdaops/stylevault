  ...
  return (
    <footer className="border-t border-white/10 bg-stone-950/90">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-8">
        <div>
          <div className="inline-flex items-center rounded-full border border-orange-400/30 bg-orange-500/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-orange-300">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link href="/get-started" className="rounded-full border border-white/15 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-stone-400">Demo routes</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-stone-400">Why Pro works</h3>
            <ul className="mt-4 space-y-3 text-sm text-stone-300">
