    ...
    <div className="mx-auto max-w-md rounded-2xl border border-violet-200/70 bg-white/90 p-6 shadow-sm dark:border-stone-800 dark:bg-black/70">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          }} onBlur={() => validateField('name')} className="mt-1 w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-300 dark:border-stone-700 dark:bg-stone-900" aria-invalid={Boolean(fieldErrors.name)} />
        ...
        <div>
          ...
          }} onBlur={() => validateField('email')} className="mt-1 w-full rounded-md border px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-300 dark:border-stone-700 dark:bg-stone-900" aria-invalid={Boolean(fieldErrors.email)} />
