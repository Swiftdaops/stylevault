...
import { loginHairSpecialist } from '@/lib/hair-specialist-api'
import { Button } from '@/components/ui/button'

export default function HairSpecialistLoginForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await loginHairSpecialist(email, password)
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-rose-200/70 bg-white/90 p-6 shadow-sm dark:border-stone-800 dark:bg-black/70">
      <h2 className="mb-4 text-2xl font-semibold">Hair Specialist Login</h2>
